using static Asprtu.Rtu.DLT645.Serialization.DataFormats;
    ...
    private static readonly Dictionary<uint, DataFormat> _map
            = new()
            {
                // 电压数据 (格式: XXX.X V, 2字节)
                {
                    ...
                    new( "A相电压","V", "XXX.X", ValueEncoding.Bcd ,2)
                },{
                ...
                // 电能数据 (格式: XXXXXX.XX kWh/kvarh, 4字节)
                {
                    ...
                    new("组合有功总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.ForwardActiveTotalEnergy),
                    new("正向有功总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.ReverseActiveTotalEnergy),
                    new("反向有功总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.CombinedActiveRate1Energy),
                    new("组合有功费率1电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.CombinedReactive1TotalEnergy),
                    new("组合无功1总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.CombinedReactive2TotalEnergy),
                    new("组合无功2总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.Quadrant1ReactiveTotalEnergy),
                    new("第一象限无功总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.Quadrant2ReactiveTotalEnergy),
                    new("第二象限无功总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.Quadrant3ReactiveTotalEnergy),
                    new("第三象限无功总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },{
                    ((uint)Command.EnergyData.Quadrant4ReactiveTotalEnergy),
                    new("第四象限无功总电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },
                ...
                // DLT645-1997 总有功电能 (格式: XXXXXX.XX kWh, 4字节)
                {
                    ...
                    new("总有功电能","kWh", "XXXXXX.XX", ValueEncoding.Bcd ,4)
                },
