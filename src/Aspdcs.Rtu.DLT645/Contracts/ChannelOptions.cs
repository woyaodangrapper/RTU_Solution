...
#pragma warning restore CA1034 // 嵌套类型应不可见
    {
        ...
        /// <summary>
        /// 初始化 <see cref="Builder"/> 类的新实例。
        /// </summary>
        /// <param name="channelName">通道唯一名称</param>
        public Builder(string channelName = "MyChannel")
        {
            ThrowHelper.ThrowIfNullOrWhiteSpace(channelName, nameof(channelName));
        ...
        /// 设置 LoggerFactory
        /// </summary>
        public Builder WithLogger(ILoggerFactory? factory)
        {
        ...
        public Builder WithCom(ComOptions options)
        {
            _port = options;
            return this;
        }
        ...
        public Builder WithChannel(string comPort, params byte[] addresses)
        {
        ...
        /// <returns>当前构建器实例</returns>
        public Builder WithChannel(string comPort, string addresses)
        {
            ThrowHelper.ThrowIfNullOrWhiteSpace(comPort, nameof(comPort));
        ...
        /// <param name="comPort">串口名称（如 COM1）</param>
        /// <returns>当前构建器实例</returns>
        public Builder WithChannel(string comPort)
        {
            ThrowHelper.ThrowIfNullOrWhiteSpace(comPort, nameof(comPort));
        ...
        /// <returns>当前构建器实例</returns>
        public Builder WithTimeout(TimeSpan timeSpan)
        {
        ...
        /// <returns>当前构建器实例</returns>
        public Builder WithMaxLength(int maxFrameLength)
        {
