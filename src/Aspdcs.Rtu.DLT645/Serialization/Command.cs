...
public static class Command
{
    ...
    #endregion 电能量 (Energy Data) - 00 xx xx xx
    ...
    #endregion 最大需量 (Maximum Demand) - 01 xx xx xx
    ...
    #endregion 瞬时量/变量 (Variables) - 02 xx xx xx
    ...
    #endregion 参变量 (Parameters) - 04 xx xx xx
    ...
    #endregion 冻结类型 (Freeze Types) - 07 xx xx xx
